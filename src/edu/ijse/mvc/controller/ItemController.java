...
public class ItemController {
    ...
    public String updateItem(ItemDto itemDto, String ic) throws SQLException, ClassNotFoundException{
        String resp = ITEM_MODEL.update(itemDto, ic);
        return resp;
    }
    
    public String deleteItem(String ic) throws SQLException, ClassNotFoundException{
        String resp = ITEM_MODEL.delete(ic);
        return resp;
    }
}
